...
/* ---------------------------------------------------------------
   ...
   --------------------------------------------------------------- */
const HOLIDAYS = [
  { id: "midautumn", zh: "中秋節", en: "Mid-Autumn Festival", deco: "🥮🌕🐇✨", color: "#C98A2D",
  ...
  { id: "double10", zh: "雙十節", en: "National Day", deco: "🎆🎇✨", color: "#B03A48",
  ...
  { id: "halloween", zh: "萬聖節", en: "Halloween", deco: "🎃👻🍬", color: "#C96A2D",
  ...
  { id: "dragonboat", zh: "端午節", en: "Dragon Boat Festival", deco: "🐉🛶🌾", color: "#3E7C59",
  ...
  { id: "eid", zh: "開齋節", en: "Eid al-Fitr", deco: "🌙⭐🕌", color: "#3A5BA0",
